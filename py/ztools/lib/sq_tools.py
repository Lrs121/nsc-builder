...
def kgstring():
	...
	kg18 = [1207960692];
	kg.append(kg18)
	kg17 = [1140851708, 1140916284];
	kg.append(kg17)
	kg16 = [1073741824, 1073807360, 1073872896, 1073938432, 1074790400];
	kg.append(kg16)
	kg15 = [1006632960, 1006698496];
	kg.append(kg15)
	kg14 = [939524096, 940572672, 940638208, 940703744];
	kg.append(kg14)
	kg13 = [872415232, 873463808, 874512404, 874578000];
	kg.append(kg13)
	kg12 = [806354944];
	kg.append(kg12)
	kg11 = [605028352, 606076928, 671088640, 671154176, 671219712, 671285248, 671350784, 672137216, 672202752,
			673185792, 738197504, 738263040, 805306368, 805371904, 805437440, 805502976];
	kg.append(kg11)
	kg10 = [603979776, 604045312];
	kg.append(kg10)
	kg9 = [537919488];
	kg.append(kg9)
	kg8 = [536936448, 536870912, 469827584, 469762048];
	kg.append(kg8)
	kg7 = [404750336];
	kg.append(kg7)
	kg6 = [403701760, 402718720, 402653184];
	kg.append(kg6)
	kg5 = [336592896, 335675392, 335609856, 335544320];
	kg.append(kg5)
	kg4 = [269484032, 268500992, 268435456];
	kg.append(kg4)
	kg3 = [201457664, 201392128];
	kg.append(kg3)
	kg2 = [201326592];
	kg.append(kg2)
	kg1 = [262144, 196608, 131072, 65536];
	kg.append(kg1)
	kg0 = [450, 0];
	kg.append(kg0)
	return kg
...
def get_xciheader(oflist, osizelist, sec_hashlist):
	...
	root_header, upd_header, norm_header, sec_header, rootSize, upd_multiplier, norm_multiplier, sec_multiplier = hfs0.gen_rhfs0_head(
		upd_list, norm_list, sec_list, sec_fileSizes, sec_shalist)
...
def count_content(filepath, filelist=None):
	counter = 0
	if files_list == None:
		if filepath.endswith('.nsp') or filepath.endswith('.nsx') or filepath.endswith('.nsz') or filepath.endswith(
				'.ns0'):
